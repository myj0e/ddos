...
{
	//ARGV argv=(ARGV)*(ARGV*)arg_v; 
	//struct sockaddr_in *addr=argv;
...
int syn()
{
	char dst[100],port[100];
	printf("Please input your target address(e.g. '1.2.3.4' or 'www.example.com') :\n>>> ");
	scanf("%s",dst);
	printf("Please input your target port(e.g. '80' or '65536') :\n>>> ");
	scanf("%s",port);
	struct sockaddr_in addr;
